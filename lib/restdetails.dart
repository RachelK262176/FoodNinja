...
import 'package:foodninja/foodscreen.dart';
import 'package:foodninja/restaurant.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:http/http.dart' as http;

void main() => runApp(RestScreenDetails());
...
class _RestScreenDetailsState extends State<RestScreenDetails> {
      ...
      body: Column(children: [
        Container(
            ...
            child: CachedNetworkImage(
              imageUrl:
                  "http://rachelcake.com/foodninja/images/restaurantimages/${widget.rest.restimage}.jpg",
              fit: BoxFit.cover,
                          ...
                          child: Column(
                            children: [
                              Container(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl:
                                        "http://rachelcake.com/foodninja/images/foodimages/${foodList[index]['foodid']}.jpg",
                                    fit: BoxFit.cover,
  ...
  void _loadFoods() {
    http.post("https://rachelcake.com/foodninja/php/load_foods.php", body: {
    ...
    Navigator.push(
        ...
        MaterialPageRoute(
            builder: (BuildContext context) =>
                FoodScreenDetails(food: curfood)));
  }
}
